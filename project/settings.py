...
# Render 本番環境は DATABASE_URL、ローカルは個別の環境変数を使用
...
# Render 本番環境用 CSRF 設定（例: CSRF_TRUSTED_ORIGINS=https://irocoro.onrender.com）
